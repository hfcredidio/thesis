...
More often than not, these objects interact in a very complicated manner,
motivating great efforts to create realistic models to capture the essential
physical properties of these systems. Some phenomena however, have properties
that seem to depend not on the details of the interactions, but on the ways the
parts of a system can organize themselves in the border of a phase transition.
