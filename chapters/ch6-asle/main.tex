...
%In order to
%study whether the scaling is isotropic or anisotropic, the root mean squared
%estimation of the displacement of the trace was computed in each direction,
%that is,
%\begin{equation}
    %\label{eq:correl}
